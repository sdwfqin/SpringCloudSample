...
import com.sdwfqin.cloudsample.auth.service.impl.UserDetailsServiceImpl;
...
public class OAuth2AuthorizationConfig extends AuthorizationServerConfigurerAdapter {
    ...
    private static final String finalSecret = "sdwfqin";
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        ...
        clients.inMemory()
                ...
                .withClient("android")
                .secret(passwordEncoder.encode(finalSecret))
